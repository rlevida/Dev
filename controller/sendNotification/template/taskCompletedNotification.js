...
module.exports = async (params) => {
    ...
    const emailReceiver = func.toCapitalizeFirstLetter(firstName);
    const url = `${`${process.env.NODE_ENV == "production" ? "https:" : "http:"}${global.site_url}account#/my-tasks?status=Completed&tab=${memberType || "assignedToMe"}`}`
    const html =
        `
                    ...
                    <table style="width:100%; table-layout: fixed;">
                        <thead>
                            <tr style="font-size: .90em!important;">
                                <th style="letter-spacing; text-align: -webkit-center; padding: .625em; white-space: pre-wrap; word-wrap: break-word;">TASK NAME</th>
                                <th style="letter-spacing; text-align: -webkit-center; padding: .625em; white-space: pre-wrap; word-wrap: break-word;">DEADLINE</th>
                                <th style="letter-spacing; text-align: -webkit-center; padding: .625em; white-space: pre-wrap; word-wrap: break-word;">COMPLETED ON</th>
                                <th style="letter-spacing; text-align: -webkit-center; padding: .625em; white-space: pre-wrap; word-wrap: break-word;">NAME</th>
                                <th style="letter-spacing; text-align: -webkit-center; padding: .625em; white-space: pre-wrap; word-wrap: break-word;">PROJECT</th>
                            </tr>
                        </thead>
                        <tbody>
                            ${
        tasks.map((userTask) => {
            const { task_project, task } = { ...userTask };
            ...
            return (
                `
                                            <tr>
                                                ...
                                                <td style="font-size: .90em!important; text-align: center; padding: .500em; white-space: pre-wrap; word-wrap: break-word;"><p style="margin:0;">${moment(userTask.dateCompleted).format("MMMM DD, YYYY")}</p></td>
