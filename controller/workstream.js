...
exports.get = {
    index: async (req, cb) => {
        ...
        const limit = 10;
        const whereObj = {
            ...(typeof queryString.workstreamId != "undefined" && queryString.workstreamId != "" ? { id: parseInt(queryString.workstreamId) } : {}),
            ...(typeof queryString.projectId != "undefined" && queryString.projectId != "" ? { projectId: parseInt(queryString.projectId) } : {}),
