...
export default class UserForm extends React.Component {
    constructor(props) {
        ...
        _.map(["handleChange", "handleChangePassword", "handleDate", "handleSubmit", "setDropDown", "setTeamList", "fetchTeamList"], fn => {
    ...
    handleSubmit(e) {
        ...
        if (users.Selected.username === "default" || users.Selected.firstName === "default" || users.Selected.lastName === "default") {
            showToast("error", "Invalid Username / First Name / Last Name.");
            return;
        }
    ...
    render() {
        ...
        const surpervisorSelectList = _(teams.SelectList)
            .map(({ teamLeader, id }) => {
                return { id: teamLeader.id, name: teamLeader.firstName + " " + teamLeader.lastName, teamId: id, image: teamLeader.avatar };
            })
            .filter(p => {
                return _.includes(
                    _.map(users.Selected.team, ({ value }) => {
                        return value;
                    }),
                    p.teamId
                );
        ...
        let teamList = [
            ...teams.SelectList,
            ..._.map(team, ({ value: id, label: name, teamLeader }) => {
                return { id, name, teamLeader };
            })
        ];
            ...
            <div class="row content-row">
                <div class="col-md-6" id={typeof users.Selected.id != "undefined" && users.Selected.id != "" ? "user-form-wrapper" : ""}>
                    <div>
                        <form id="user-form">
                            <div class="mb20">
                                <p class="form-header mb0">{profileEdit == false ? "Users" : "Profile Information"}</p>
                                <p>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="username" required value={typeof users.Selected.username == "undefined" ? "" : users.Selected.username} class="form-control" placeholder="Enter username" onChange={this.handleChange} />
                            </div>
                            {profileEdit == false && (
                                <div class="form-group">
                                    <label>
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    type="number"
                                    name="phoneNumber"
                                    value={typeof users.Selected.phoneNumber != "undefined" && users.Selected.phoneNumber ? users.Selected.phoneNumber : ""}
                                    class="form-control"
                            ...
                            {profileEdit == false && (
                                <div>
                                    ...
                                    {typeof users.Selected.userType != "undefined" && users.Selected.userType != "" && (
                                        <div class="form-group">
                                            <label>
                                    ...
                                    {users.Selected.userType == "External" && (
                                        <div class="form-group">
                                            <label>Company:</label>
                                            <input type="text" name="company" value={typeof users.Selected.company == "undefined" ? "" : users.Selected.company} class="form-control" placeholder="Enter company" onChange={this.handleChange} />
                                        </div>
                                    )}
                                    {users.Selected.userType == "Internal" && (
                                        <div class="form-group">
                                            <label>Team/s:</label>
                                            <DropDown
                                                multiple={true}
                                    ...
                                    {users.Selected.userType == "Internal" && (
                                        <div class="form-group pointer-none">
                                            ...
                                            <DropDown
                                                ...
                                                selected={_.map(surpervisorSelectList, o => {
                                                    return { value: o.id };
                                                })}
