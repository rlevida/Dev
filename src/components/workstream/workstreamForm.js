...
export default class WorkstreamForm extends React.Component {
    ...
    fetchMemberList(options) {
        ...
        let fetchUrl = `/api/project/getProjectMembers?page=1&linkId=${project.Selected.id}&linkType=project&project_type=${project.Selected.type.type}&memberType=responsible&isActive=1`;
