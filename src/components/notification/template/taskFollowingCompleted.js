        ...
        return (
            <div key={index}>
                <li class={`pd0 mb20 ${data.isRead ? "" : "n-unread"}`}>
                    <div class="d-flex-sb">
                        <div class="n">
                            <a href="javascript:void(0)" onClick={() => handleNotificationRedirect(data)}><p class="m0"><i class={`fa fa-check-circle mr5 ${data.isRead ? "text-green" : ""}`}></i>Task following in <strong>{workstream}</strong></p></a>
                            <div>
