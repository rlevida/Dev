                ...
                <div class="row content-row">
                    <div class="col-md-6 col-sm-6 col-xs-12 pd0">
                        <div class="flex-row tab-row mb0">
                            <div class="flex-col">
                                <a class={Filter.isArchived === 0 ? "btn btn-default btn-active" : "btn btn-default"} onClick={() => this.setDropDown("isArchived", 0)}>
                                    Notification
                                </a>
                            </div>
                            <div class="flex-col">
                                <a class={Filter.isArchived === 1 ? "btn btn-default btn-active" : "btn btn-default"} onClick={() => this.setDropDown("isArchived", 1)}>
                                    Archived
                                </a>
                            </div>
                    ...
                    {Filter.isArchived === 0 && (
                        <div class="col-md-6 col-sm-6 col-xs-12 pd0">
                            <div class="button-action">
                                <a class="btn btn-default mr10" data-toggle="modal" data-target="#markAsReadModal">
                                    <span>
