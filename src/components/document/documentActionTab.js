                ...
                <div class="row content-row">
                    <div class="col-md-6 col-sm-6 col-xs-12 pd0">
                        <div class="flex-row tab-row mb0">
                            <div class="flex-col">
                                <a class={document.ActiveTab === 'active' ? "btn btn-default btn-active" : "btn btn-default"} onClick={() => this.setDropDown('active')}>Active Files</a>
                            </div>
                            <div class="flex-col">
                                <a class={document.ActiveTab === 'library' ? "btn btn-default btn-active" : "btn btn-default"} onClick={() => this.setDropDown('library')}>Library</a>
                            </div>
                            <div class="flex-col">
                                <a class={document.ActiveTab === 'sort' ? "btn btn-default btn-active" : "btn btn-default"} onClick={() => this.setDropDown('sort')}>Sort Files</a>
                            </div>
                            <div class="flex-col">
                                <a class={document.ActiveTab === 'trash' ? "btn btn-default btn-active" : "btn btn-default"} onClick={() => this.setDropDown('trash')}>Trash</a>
                            </div>
                            <div class="flex-col">
