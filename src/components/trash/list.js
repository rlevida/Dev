...
export default class List extends React.Component {
    ...
    sortDocument(type) {
        ...
        if (document.Trash.length > 0) {
            const sortedDocument = _.orderBy(document.Trash, [`${type}`], [`${order == "asc" ? "desc" : "asc"}`]).map(e => {
                return e;
            });
            this.setState({
                ...this.state,
                ...
                <table id="dataTable" class="table responsive-table table-bordered document-table">
                    <tbody>
                        <tr>
                            ...
                            <th>
                                <a href="javascript:void(0)" onClick={() => this.sortDocument("dateUpdated")}>
                                    Uploaded
                                </a>
                            </th>
                            <th>By</th>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu  pull-right" aria-labelledby="dropdownMenu2">
                                                <li>
                                                    <a href="javascript:void(0);" data-tip="Delete" onClick={e => this.deleteDocument(data)}>
                                                        Delete
                                                    </a>
                                                </li>
                                            </ul>
